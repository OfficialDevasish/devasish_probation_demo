import 'dart:async';
import 'dart:convert';
import 'package:apicall/models/apimodel.dart';
...
class newfile extends StatefulWidget {
  ...
  @override
  newfileState createState() => newfileState();
}



class newfileState extends State<newfile> {
  final _Apimodel = Apimodel();

  List<Subject> ulist = [];
  List<Subject> userLists = [];
  //API call for All Subject List

  String url = 'https://blitzsen.tecocraft.net/api/products/search';
